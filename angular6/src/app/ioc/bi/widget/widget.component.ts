import { Component, ComponentFactoryResolver, OnInit, AfterViewInit, ViewChild, ViewContainerRef, TemplateRef, Renderer2 } from '@angular/core';
...
import { REQUEST_OPTIONS, DataService, UpdateService, ParamSelectorComponent } from 'app/pack/common/src/index';
import { TreeConfig, TreeConfigService, ChartService } from 'app/pack/common/src/index';

// 数据源过滤器弹框
import { FilterGroupComponent } from './manage/filter-group.component';
import { VFilterComponent } from './manage/vFilter.component';

import {NgbDropdownConfig} from '@ng-bootstrap/ng-bootstrap';
@Component({
    template: require('./widget.component.html!text'),
...
export class WidgetComponent implements OnInit, AfterViewInit {
    ...
    /** Ace Editor Starer... **/
    // queryAceOpt = this.datasetEditorOptions();
}