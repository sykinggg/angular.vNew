...
var ChartScatterService = /** @class */ (function () {
    function ChartScatterService(activatedRoute, updateEchartOptions) {
        this.activatedRoute = activatedRoute;
        this.updateEchartOptions = updateEchartOptions;
    }
    ChartScatterService.prototype.render = function (containerDom, option, scope, persist, drill, relations, chartConfig) {
        var render = new render_1.Render(containerDom, option);
        render.addClick(chartConfig, relations, this.activatedRoute);
        return render.chart(null, persist);
    };
    ;
    ChartScatterService.prototype.parseOption = function (data) {
    ...
    ;
    ChartScatterService = tslib_1.__decorate([
        core_1.Injectable(),
        tslib_1.__metadata("design:paramtypes", [router_1.ActivatedRoute,
            updateechartOptions_service_1.UpdateEchartOptionsService])
    ], ChartScatterService);
    return ChartScatterService;
}());
exports.ChartScatterService = ChartScatterService;

//# sourceMappingURL=../../sourcemaps/src/chart/chartScatter.service.js.map
