...
var ChartChinaMapService = /** @class */ (function () {
    function ChartChinaMapService(cBoardHeatMapRenderService) {
        this.cBoardHeatMapRenderService = cBoardHeatMapRenderService;
    }
    ChartChinaMapService.prototype.render = function (containerDom, option, scope, persist, drill) {
        if (option == null) {
    ...
    ;
    ChartChinaMapService.prototype.parseOption = function (data) {
        var optionData = [];
        var seriesData = [];
    ...
    ;
    ChartChinaMapService = tslib_1.__decorate([
        core_1.Injectable(),
        tslib_1.__metadata("design:paramtypes", [cBoardHeatMapRender_service_1.CBoardHeatMapRenderService])
    ], ChartChinaMapService);
    return ChartChinaMapService;
}());
exports.ChartChinaMapService = ChartChinaMapService;

//# sourceMappingURL=../../sourcemaps/src/chart/chartChinaMap.service.js.map
