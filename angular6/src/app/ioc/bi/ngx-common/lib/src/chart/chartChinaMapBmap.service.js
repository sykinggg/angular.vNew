...
var ChartChinaMapBMapService = /** @class */ (function () {
    function ChartChinaMapBMapService(cBoardBMapRenderService) {
        this.cBoardBMapRenderService = cBoardBMapRenderService;
    }
    ChartChinaMapBMapService.prototype.render = function (containerDom, option, scope, persist, drill) {
        if (option == null) {
    ...
    ;
    ChartChinaMapBMapService.prototype.parseOption = function (data) {
        var optionData = [];
        var seriesData = [];
    ...
    ;
    ChartChinaMapBMapService = tslib_1.__decorate([
        core_1.Injectable(),
        tslib_1.__metadata("design:paramtypes", [cBoardBMapRender_service_1.CBoardBMapRenderService])
    ], ChartChinaMapBMapService);
    return ChartChinaMapBMapService;
}());
exports.ChartChinaMapBMapService = ChartChinaMapBMapService;

//# sourceMappingURL=../../sourcemaps/src/chart/chartChinaMapBmap.service.js.map
