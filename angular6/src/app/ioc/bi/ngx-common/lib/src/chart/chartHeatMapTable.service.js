...
var ChartHeatMapTableService = /** @class */ (function () {
    function ChartHeatMapTableService(translateService) {
        this.translateService = translateService;
    }
    ChartHeatMapTableService.prototype.render = function (containerDom, option, scope, persist) {
        if (option == null) {
    ...
    ;
    ChartHeatMapTableService.prototype.parseOption = function (data) {
        var self = this;
    ...
    ;
    ChartHeatMapTableService = tslib_1.__decorate([
        core_1.Injectable(),
        tslib_1.__metadata("design:paramtypes", [core_2.TranslateService])
    ], ChartHeatMapTableService);
    return ChartHeatMapTableService;
}());
exports.ChartHeatMapTableService = ChartHeatMapTableService;

//# sourceMappingURL=../../sourcemaps/src/chart/chartHeatMapTable.service.js.map
