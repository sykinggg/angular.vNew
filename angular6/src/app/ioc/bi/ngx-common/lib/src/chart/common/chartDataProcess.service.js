...
var ChartDataProcessService = /** @class */ (function () {
    function ChartDataProcessService() {
    }
    ChartDataProcessService.prototype.chartDataProcess = function (chartConfig, casted_keys, casted_values, aggregate_data, newValuesConfig) {
        var keysList = casted_keys, keyArr = [], emptyList = [], keyLength = chartConfig.keys.length, rowHeaderLength = keysList[0] ? keysList[0].length : 0;
    ...
    ;
    ChartDataProcessService = tslib_1.__decorate([
        core_1.Injectable(),
        tslib_1.__metadata("design:paramtypes", [])
    ], ChartDataProcessService);
    return ChartDataProcessService;
}());
exports.ChartDataProcessService = ChartDataProcessService;

//# sourceMappingURL=../../../sourcemaps/src/chart/common/chartDataProcess.service.js.map
