...
var CrossTableService = /** @class */ (function () {
    function CrossTableService(translateService) {
        this.translateService = translateService;
    }
    CrossTableService.prototype.table = function (args) {
        var data = args.data, chartConfig = args.chartConfig, tall = args.tall, pageDataNum = 20, drill = args.drill, random = Math.random().toString(36).substring(2), container = args.container;
        var html = "<table class = 'table_wrapper' id='tableWrapper" + random + "'><thead class='fixedHeader'>", colContent = "<tr>";
    ...
    ;
    CrossTableService.prototype.bandDrillEvent = function (t_class, drill, render) {
    ...
    ;
    CrossTableService.prototype.paginationProcessData = function (rawData, headerLines, pageSize) {
    ...
    ;
    CrossTableService.prototype.render = function (data, chartConfig, drill) {
        var html = '';
        if (data === undefined) {
            return html;
        }
    ...
    ;
    CrossTableService.prototype.selectDataNum = function (data, num, chartConfig, drill, random, t_class, render) {
        var _this = this;
    ...
    ;
    CrossTableService.prototype.clickPageNum = function (data, chartConfig, drill, random) {
        var _this = this;
    ...
    ;
    CrossTableService.prototype.renderPagination = function (pageCount, pageNumber, pageObj, target) {
        if (pageCount == 1) {
    ...
    ;
    CrossTableService.prototype.buttonColor = function (pageNum, target) {
        if (target) {
    ...
    ;
    CrossTableService.prototype.clickNextPrev = function (pageCount, pageObj, random) {
        var _this = this;
    ...
    ;
    CrossTableService.prototype.export = function (random, data) {
    ...
    ;
    CrossTableService = tslib_1.__decorate([
        core_1.Injectable(),
        tslib_1.__metadata("design:paramtypes", [core_2.TranslateService])
    ], CrossTableService);
    return CrossTableService;
}());
exports.CrossTableService = CrossTableService;
;

//# sourceMappingURL=../../../sourcemaps/src/chart/common/crossTable.service.js.map
