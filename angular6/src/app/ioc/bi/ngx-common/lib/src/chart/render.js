...
var Render = /** @class */ (function () {
    function Render(jqContainer, options, isDeepSpec) {
    ...
    Render.prototype.chart = function (group, persist) {
        var self = this;
    ...
    ;
    Render.prototype.changeSize = function (instance) {
    ...
    ;
    Render.prototype.addClick = function (chartConfig, relations, $state) {
        ...
        self.ecc.on('click', function (param) {
            ...
            var relations_new = [];
            _.each(relations_old, function (relation_old) {
                var exists = false;
            ...
            _.each(_.filter(links, function (e) { return e.type == "board"; }), function (relation) {
                ...
                var url = $state.navigate(['/admin/mine/view'], navigationExtras);
...
//# sourceMappingURL=../../sourcemaps/src/chart/render.js.map
