...
@Component({
    selector: 'app-video-stream-music',
    templateUrl: './video-stream-music.component.html',
    styleUrls: ['./video-stream-music.component.scss']
})
export class VideoStreamMusicComponent implements OnInit {
     ...
     *
     * 初始化音频播放器
     * @memberof VideoStreamMusicComponent
     */
    public defaultMusic() {
        let lyricTxt = `[00:00.00] 作曲 : 林家谦\n[00:00.00] 作词 : 徐世珍/吴辉福\n[00:00.000]编曲：林家谦\n[00:00.000]时钟不要走\n[00:04.220]让我脆弱一分钟\n[00:07.440]要多久才能
        ...
        let player = this.videoServiceService.defaultXglayerMusic({
            id: 'vs',
            url: [
                {
                    src: './assets/sourceVideo/test.mp3',
                    name: 'test',
                    vid: '10000000'
                }
            ],
        ...
        // let ly = player.lyric(lyricTxt, document.querySelector('.lyric'))
        // ly.show()
