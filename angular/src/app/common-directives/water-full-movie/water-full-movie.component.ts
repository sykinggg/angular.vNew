...
@Component({
    selector: 'app-water-full-movie',
    templateUrl: './water-full-movie.component.html',
    styleUrls: ['./water-full-movie.component.scss']
})
export class WaterFullMovieComponent implements OnInit {
