...
export class SubscriberComponent implements OnInit {
    // 以下是angular 6.0 及以上
    // public location1: Observable<{}>;
    // public locationsSubscription: any;
    constructor() {
        // 第一个栗子报错mb的官网
        // this.location1 = new Observable((observer) => {
        ...
        //     }};
        // });
        // this.locationsSubscription = this.location1.subscribe({
    ...
    // 以下是angular 6.0 以下的rxJs的使用（麻痹的连他妈google的都他妈这么个）
    /**
