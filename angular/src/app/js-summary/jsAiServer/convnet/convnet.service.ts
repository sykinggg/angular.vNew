...
export class ConvnetService {
    ...
    public defaultConvent() {
        let convnetjs = this.convnetjs || { REVISION: 'ALPHA' };
        (function (global) {
            "use strict";
            ...
            let arrContains = function (arr, elt) {
            ...
            let weightedSample = function (lst, probs) {
                let p = randf(0, 1.0);
                let cumprob = 0.0;
        ...
        (function (global) {
            ...
            let Vol = function (sx, sy, depth, c) {
                // this is how you check if a letiable is an array. Oh, Javascript :)
                if (Object.prototype.toString.call(sx) === '[object Array]') {
                    ...
                    if (typeof c === 'undefined') {
                        ...
                        // letiance of every neuron, otherwise neurons with a lot
                        // of incoming connections have outputs of larger letiance
            ...
            Vol.prototype = {
                ...
                addFrom: function (V) { for (let k = 0; k < this.w.length; k++) { this.w[k] += V.w[k]; } },
                addFromScaled: function (V, a) { for (let k = 0; k < this.w.length; k++) { this.w[k] += a * V.w[k]; } },
                setConst: function (a) { for (let k = 0; k < this.w.length; k++) { this.w[k] = a; } },
        ...
        (function (global) {
            ...
            let augment = function (V, crop, dx, dy, fliplr) {
                ...
                if (typeof (fliplr) === 'undefined') { let fliplr = false; }
                if (typeof (dx) === 'undefined') { let dx = global.randi(0, V.sx - crop); }
                if (typeof (dy) === 'undefined') { let dy = global.randi(0, V.sy - crop); }
            ...
            let img_to_vol = function (img, convert_grayscale) {

                if (typeof (convert_grayscale) === 'undefined') { let convert_grayscale = false; }
        ...
        (function (global) {
            ...
            let ConvLayer = function (InOpt: any) {
                let opt = InOpt || {};
            ...
            ConvLayer.prototype = {
                forward: function (V, is_training) {
                    ...
                    let A = new Vol(this.out_sx | 0, this.out_sy | 0, this.out_depth | 0, 0.0);
                    ...
                    for (let d = 0; d < this.out_depth; d++) {
                        ...
                        for (let ay = 0; ay < this.out_sy; y += xy_stride, ay++) {  // xy_stride
                            ...
                            for (let ax = 0; ax < this.out_sx; x += xy_stride, ax++) {  // xy_stride
                                ...
                                // convolve centered at this particular location
                                let chain_grad = this.out_act.get_grad(ax, ay, d); // gradient from above, from chain rule
                                for (let fy = 0; fy < f.sy; fy++) {
                                    let oy = y + fy; // coordinates in the original input array coordinates
                                    for (let fx = 0; fx < f.sx; fx++) {
                                        let ox = x + fx;
            ...
            let FullyConnLayer = function (inOpt: any) {
                let opt = inOpt || {};
        ...
        (function (global) {
            ...
            let PoolLayer = function (inOpt: any) {
        ...
        (function (global) {
            "use strict";
            let Vol = global.Vol; // convenience
            let getopt = global.getopt;

            let InputLayer = function (inOpt: any) {
                let opt = inOpt || {};
        ...
        (function (global) {
            ...
            let SoftmaxLayer = function (inOpt: any) {
                let opt = inOpt || {};
            ...
            SoftmaxLayer.prototype = {
                forward: function (V, is_training) {
                    ...
                    let es = global.zeros(this.out_depth);
                    let esum = 0.0;
                    for (let i = 0; i < this.out_depth; i++) {
            ...
            let RegressionLayer = function (inOpt: any) {
                let opt = inOpt || {};
            ...
            let SVMLayer = function (inOpt: any) {
                let opt = inOpt || {};
        ...
        (function (global) {
            ...
            let ReluLayer = function (inOpt: any) {
                let opt = inOpt || {};
            ...
            ReluLayer.prototype = {
                ...
                backward: function () {
                    ...
                    for (let i = 0; i < N; i++) {
                        if (V2.w[i] <= 0) { V.dw[i] = 0; } else { V.dw[i] = V2.dw[i]; }
                    }
                },
                getParamsAndGrads: function () {
                    return [];
            ...
            let SigmoidLayer = function (inOpt: any) {
                let opt = inOpt || {};
            ...
            let MaxoutLayer = function (inOpt: any) {
                let opt = inOpt || {};
            ...
            let TanhLayer = function (inOpt: any) {
                let opt = inOpt || {};
        ...
        (function (global) {
            ...
            let DropoutLayer = function (inOpt: any) {
                let opt = inOpt || {};
            ...
            DropoutLayer.prototype = {
                forward: function (V, is_training) {
                    ...
                    if (is_training) {
                        // do dropout
                        for (let i = 0; i < N; i++) {
                            if (Math.random() < this.drop_prob) { V2.w[i] = 0; this.dropped[i] = true; } else { this.dropped[i] = false; }
                        }
                    } else {
        ...
        (function (global) {
            ...
            let LocalResponseNormalizationLayer = function (inOpt: any) {
                let opt = inOpt || {};
        ...
        (function (global) {
            ...
            Net.prototype = {
                ...
                getCostLoss: function (V, y) {
                    ...
                    let loss = this.layers[N - 1].backward(y);
                    return loss;
                },
                ...
                backward: function (y) {
                    let N = this.layers.length;
                    let loss = this.layers[N - 1].backward(y); // last layer assumed to be loss layer
                ...
                getParamsAndGrads: function () {
                    ...
                    for (let i = 0; i < this.layers.length; i++) {
                        let layer_reponse = this.layers[i].getParamsAndGrads();
        ...
        (function (global) {
            ...
            let Trainer = function (net, inOptions: any) {
        ...
        (function (global) {
            ...
            let randf = global.randf;
            let randi = global.randi;
            let Net = global.Net;
            let Trainer = global.Trainer;
            let maxmin = global.maxmin;
            let randperm = global.randperm;
            let weightedSample = global.weightedSample;
            let getopt = global.getopt;
            let arrUnique = global.arrUnique;
            ...
            */
            let MagicNet = function (data, labels, inOpt) {
                let opt = inOpt || {};
